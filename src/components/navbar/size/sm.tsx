                ...
                <div className="flex justify-between items-center px-6 py-4 backdrop-blur-md">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className={`w-12 h-12 flex items-center justify-center rounded-full border-2 ${themeClass}`}
                        >
                            {mode === 'right' ? (
                                <FaMoon size={21} />
                            ) : (
                        ...
                        {menuItems.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={`w-full text-center text-xl font-semibold py-3 ${borderClass} transition-colors duration-200
