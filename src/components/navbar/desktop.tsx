    ...
    return (
      <div className="min-h-screen flex flex-col relative font-outfit">
        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          <nav className="mt-5 px-12 py-4 flex justify-between items-center">
            <Link
              href="/"
              className={`ml-16 flex items-center justify-center overflow-hidden rounded-full border h-10 min-w-[120px] px-6
      ${isHomePage
                  ? mode === 'left'
      ...
      ${isSkillsPage
              ...
              <Link
                href="/projects"
                className={`ml-4 flex items-center gap-1 font-bold uppercase text-sm tracking-wide rounded-full h-10 min-w-[120px] px-6 justify-center transition duration-150 border
      ${isProjectsPage
                    ? mode === 'right'
                      ? 'text-white border-white bg-transparent hover:bg-white hover:text-black'
                      : 'text-black border-black bg-transparent hover:bg-black hover:text-white'
              ...
              <Link href="/contact" className="ml-auto group">
                <div
                  className={`mr-16 flex items-center justify-center h-10 min-w-[120px] px-6 rounded-full transition duration-150 font-bold uppercase text-sm tracking-wide border
        ${isContactPage
                      ? mode === 'right'
