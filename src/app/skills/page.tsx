...
export default function SkillsPage() {
  ...
  // ใช้ ref เก็บ id ของ interval เพื่อจัดการ clear ได้
  const intervalIdRef = useRef<NodeJS.Timeout | null>(null);

  // ฟังก์ชันช่วยตั้ง interval ใหม่ (รีเซ็ตคูลดาวน์)
  const startInterval = () => {
  ...
  // ฟังก์ชันจัดการเปลี่ยนหน้า (เรียกจากปุ่มใน Section)
  const handlePageChange = (section: PageKey, direction: 'left' | 'right') => {
    ...
    // รีเซ็ต interval เพื่อเริ่มนับใหม่ 6 วิ
    startInterval();
  };
