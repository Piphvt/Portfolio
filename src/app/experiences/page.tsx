...
import MobileExperiences from './size/mobile';
import DesktopExperiences from './size/desktop';
...
export default function HomePage() {
  ...
  return (
    <Navbar onModeChange={setMode}>
      {screen === 'mobile' && <MobileExperiences mode={mode} />}
      {screen === 'desktop' && <DesktopExperiences mode={mode} />}
    </Navbar>
  );
}