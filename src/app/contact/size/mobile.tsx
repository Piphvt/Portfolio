...
export default function Mobile({ mode }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className={`mx-4 max-w-[300px] sm:max-w-[320px] ${isLeftMode ? 'text-black' : 'text-white'}`}>
      ...
      <div className={`mx-4 max-w-[300px] sm:max-w-[320px] mt-4 ${isLeftMode ? 'text-black' : 'text-white'}`}>
        <CharFlip className={`text-sm sm:text-base`}>
          {ProfileText}
        </CharFlip>
      </div>
