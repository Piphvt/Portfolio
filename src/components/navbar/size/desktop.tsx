...
export default function DesktopNavbar({ children, onModeChange }: LayoutProps) {
    ...
    h-8 md:h-9 lg:h-10 min-w-[80px] md:min-w-[90px] lg:min-w-[100px] 
    px-3 md:px-4 lg:px-5 text-xs md:text-sm lg:text-base transition duration-150
    ${isHomePage
                                    ? mode === 'left'
                        ...
                        >
                            ...
                            <Image
                                ...
                                alt="Logo"
                                width={24} // ปรับขนาดตาม h-4 / md:h-5 / lg:h-6
                                height={24}
                                className="absolute h-4 md:h-5 lg:h-6 w-auto transition-opacity duration-150 opacity-100 group-hover:opacity-0"
                            />
                            ...
                            <Image
                                ...
                                width={24}
                                height={24}
                                className="h-4 md:h-5 lg:h-6 w-auto transition-opacity duration-150 opacity-0 group-hover:opacity-100"
                            />
                        </Link>
                        ...
                        <Link
                            href="/about"
                            className={`mr-1 font-bold uppercase text-xs md:text-sm lg:text-base tracking-wide rounded-full 
        h-8 md:h-9 lg:h-10 min-w-[80px] md:min-w-[90px] lg:min-w-[100px]
        px-3 md:px-4 lg:px-5 flex items-center justify-center transition duration-150 border
        ${isAboutPage
                                    ? mode === 'left'
                        ...
                        <Link
                            href="/skills"
                            className={`ml-auto mr-1 font-bold uppercase text-xs md:text-sm lg:text-base tracking-wide rounded-full 
        h-8 md:h-9 lg:h-10 min-w-[80px] md:min-w-[90px] lg:min-w-[100px]
        px-3 md:px-4 lg:px-5 flex items-center justify-center transition duration-150 border
        ${isSkillsPage
                                    ? mode === 'left'
                    ...
                    <div className="flex w-full md:w-1/2 items-center justify-between mt-3 md:mt-0">
                        <div className="flex">
                            ...
                            <Link
                                href="/projects"
                                className={`ml-1 font-bold uppercase text-xs md:text-sm lg:text-base rounded-full 
          h-8 md:h-9 lg:h-10 min-w-[80px] md:min-w-[90px] lg:min-w-[100px]
          px-3 md:px-4 lg:px-5 flex items-center justify-center transition duration-150 border
          ${isProjectsPage
                                        ? mode === 'right'
          ...
          text-xs md:text-sm lg:text-base tracking-wide rounded-full 
          h-8 md:h-9 lg:h-10 min-w-[80px] md:min-w-[90px] lg:min-w-[100px]
          px-3 md:px-4 lg:px-5 transition duration-150 border
          ${isContactPage
                                        ? mode === 'right'
                                            ? 'text-white border-white hover:bg-white hover:text-black'
                                            : 'text-black border-black hover:bg-black hover:text-white'
